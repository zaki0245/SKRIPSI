...
// Route::get('/perhitungan', [SPKSahamController::class, 'perhitungan'])->name('perhitungan');
// Route::get('/perhitungan', [SPKSahamController::class, 'hitung'])->name('perhitungan.hitung');
